...
require_once 'models/service.php';
  class Utils
  {
    ...
    static function load_services() {
      ...
      return Service::from_ini($machines_json, $services_json);
    }

    // Method: POST, PUT, GET etc
    // Data: array("param" => "value") ==> index.php?param=value
    static function rest_call($url, $data = false, $headers = [], $method = "GET",
     $auth = false, $type='application/json')
    {
        $curl = curl_init();
        ...
        if($result != false) {
          ...
          case 'application/XML':
            $result = new SimpleXMLElement($result, true);
            break;
          }
        }
        return $result;
    ...
    static function rest_xml($url, $data = false, $headers = [], $method = "GET",
     $auth = false) {
       return Utils::rest_call($url, $data, $headers, $method, $auth,
        'application/XML');
    }
